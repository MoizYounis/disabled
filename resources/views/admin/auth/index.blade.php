...
<head>
    ...
    <meta name="description" content="PWD Hub admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, PWD Hub admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>PWD Hub - Admin - Login</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="{{ route('admin') }}" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">PWD HUB</h2>
                                </a>

                                <h4 class="card-title mb-1">PWD HUB - Admin Portal! 👋</h4>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

                                <form class="auth-login-form mt-2" action="{{ route('admin_login_form') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
