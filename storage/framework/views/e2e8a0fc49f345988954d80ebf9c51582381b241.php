        ...
        <div class="card-secondary">
            ...
            <div class="card-secondary__body">
                ...
                <div class="card-secondary__body__content">
                    <form method="POST" action="<?php echo e(route('userLogin')); ?>" style="margin-left: 70px;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app_auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\muham\Music\disabled_person\resources\views/user_auth/login.blade.php ENDPATH**/ ?>