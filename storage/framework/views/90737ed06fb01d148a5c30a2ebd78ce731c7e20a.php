    ...
    <section class="section section-xl">
        <div class="container">
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-1.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-2.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-3.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-4.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-5.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
            </div>
            <h4>
            ...
            <img src="<?php echo e(asset('assets/images/sdg-6.jpeg')); ?>" class="image-fluid" style="height:160px; width:140px;">
            <p>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-7.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-10">
                    <p>
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-8.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-9.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-2">
                    <img src="<?php echo e(asset('assets/images/sdg-10.jpeg')); ?>" class="image-fluid" width="100%"
                        style="height:160px">
                </div>
                <div class="col-sm-3"></div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\muham\Music\disabled_person\resources\views/sdgs-detail.blade.php ENDPATH**/ ?>