...
<?php $__env->startSection('section'); ?>
    ...
    <section class="section section-lg section-main-bunner section-main-bunner-filter">
        <div class="main-bunner-img"
            style="background-image: url(&quot;<?php echo e(asset('assets/images/ngo-detail.jpeg')); ?>&quot;); background-size: cover;">
        </div>
    ...
    <section class="section section-xl">
        <div class="container">
            <h3 class="text-center my-5"><b><a href="<?php echo e(route('organization')); ?>?name=NGO">See All NGO's</a></b></h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\muham\Music\disabled_person\resources\views/ngo-detail.blade.php ENDPATH**/ ?>