/*=========================================================================================
    ...
    ----------------------------------------------------------------------------------------
    Item Name: PWD Hub  - Vuejs, HTML & Laravel Admin Dashboard Template
    Author: PIXINVENT
...
$(window).on('load', function() {
    ...
    var $earningsStrokeColor2 = '#5D403766';
    var $earningsStrokeColor3 = '#5D403733';
    ...
    setTimeout(function() {
        toastr['success'](
            'You have successfully logged in to PWD Hub Portal. Now you can start to explore!',
            '👋 Welcome Admin!', {
                closeButton: true,
                tapToDismiss: false,
                rtl: isRtl
